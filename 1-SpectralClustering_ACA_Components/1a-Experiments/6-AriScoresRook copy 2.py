...
if __name__ == "__main__":
    ...
    sampling_percentages = np.arange(0.01, 0.12, 0.01)
        ...
        for sp in sampling_percentages:
            ...
            with warnings.catch_warnings():
                ...
                for i in range(10):
                    ...
                    W, deltas, kbest, gamma = ACA_diag_pivots(cp, tau, kmax, Deltak, startpivot="fixed")
                    ...
                    eigv, score = myAlgo(16, W, deltas, labels)
                    scores.append(score)
    ...
    output_path = os.path.join(base_dir, "clustering_results_rook_finalRun_fixed.xlsx")
